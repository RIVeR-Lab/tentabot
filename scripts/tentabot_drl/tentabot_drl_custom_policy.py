...
NUA TODO...
"""
class lidar_1DCNN_FC_Policy(BaseFeaturesExtractor):
    ...
    def __init__(self, observation_space: gym.spaces.Dict):
        ...
        print("lidar_1DCNN_FC_Policy::__init__ -> observation_space: " + str(observation_space))

        super(lidar_1DCNN_FC_Policy, self).__init__(observation_space, features_dim=1)

        print("lidar_1DCNN_FC_Policy::__init__ -> observation_space.spaces laser shape: " + str(observation_space.spaces["laser"].shape))
        print("lidar_1DCNN_FC_Policy::__init__ -> observation_space.spaces target_action shape: " + str(observation_space.spaces["target_action"].shape))
        ...
        print("lidar_1DCNN_FC_Policy::__init__ -> cnn_input_channel_len: " + str(self.cnn_input_channel_len))
        print("lidar_1DCNN_FC_Policy::__init__ -> cnn_input_data_len: " + str(self.cnn_input_data_len))
        print("lidar_1DCNN_FC_Policy::__init__ -> fc_input_extra_data_len: " + str(self.fc_input_extra_data_len))
        ...
        print("lidar_1DCNN_FC_Policy::__init__ -> n_channel_input1: " + str(n_channel_input1))
        print("lidar_1DCNN_FC_Policy::__init__ -> n_channel_output1: " + str(n_channel_output1))
        print("lidar_1DCNN_FC_Policy::__init__ -> n_channel_input2: " + str(n_channel_input2))
        print("lidar_1DCNN_FC_Policy::__init__ -> n_channel_output2: " + str(n_channel_output2))
        print("lidar_1DCNN_FC_Policy::__init__ -> n_channel_input3: " + str(n_channel_input3))
        print("lidar_1DCNN_FC_Policy::__init__ -> n_channel_output3: " + str(n_channel_output3))
        ...
        with th.no_grad():
            ...
            print("lidar_1DCNN_FC_Policy::__init__ -> cnn_input_sample shape: " + str(cnn_input_sample.shape))

            cnn_output = self.cnn_net(th.as_tensor(cnn_input_sample).float())

            print("lidar_1DCNN_FC_Policy::__init__ -> cnn_output shape: " + str(cnn_output.shape))

            n_flatten = cnn_output.shape[1] + self.fc_input_extra_data_len

            print("lidar_1DCNN_FC_Policy::__init__ -> n_flatten: " + str(n_flatten))
...
class Tentabot_1DCNN_FC_Policy(BaseFeaturesExtractor):
    ...
    def __init__(self, observation_space: gym.spaces.Dict):
        ...
        self.cnn_net = nn.Sequential(
            ...
            nn.Conv1d(n_channel_input1, n_channel_output1, kernel_size=3, stride=2),
            nn.ReLU(),
            nn.Conv1d(n_channel_input2, n_channel_output2, kernel_size=2, stride=2),
            nn.ReLU(),
            nn.Conv1d(n_channel_input3, n_channel_output3, kernel_size=2, stride=2),
