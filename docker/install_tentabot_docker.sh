...
git clone https://github.com/RIVeR-Lab/turtlebot3.git -b noetic-akmandor  #'noetic-akmandor' branch*

# 3.5 Install 'noetic-akmandor' branch of LMS1xx package into the src folder.
git clone https://github.com/RIVeR-Lab/LMS1xx.git -b noetic-akmandor #'noetic-akmandor' branch*

# 3.6 Install 'noetic-akmandor' branch of geometry2 package into the src folder.
git clone https://github.com/RIVeR-Lab/geometry2.git -b noetic-akmandor #'noetic-akmandor' branch*
