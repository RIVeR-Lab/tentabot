...
#ifndef TENTABOT_UNIFORM_BSPLINE_3D_OPTIMIZATION_H_
#define TENTABOT_UNIFORM_BSPLINE_3D_OPTIMIZATION_H_

#include <tentabot/uniform_bspline_3d.h>
#include <tentabot/polynomial_trajectory_3d.h>
#include <tentabot/ed_ring_buffer.h>
...
class UniformBSpline3DOptimization {
 public:
  ...
  UniformBSpline3DOptimization(tentabot::PolynomialTrajectory3D<10>::Ptr & trajectory, _Scalar dt) :
 ...
 protected:
  ...
  tentabot::PolynomialTrajectory3D<10>::Ptr trajectory_;
